...
const ActivityDetailPage: React.FC = () => {
  ...
  const activityId = params.slug as string;
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-3">
                        <h3
                          ...
                          onClick={() =>
                            handleInstructorClick(content.instructor.url)
                          }
                        >
                  ...
                  <div className="p-6 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
                    <div className="flex items-center space-x-4">
                      <div className="relative">
                        <img
                          src={
                            content.technicalOperator.picture ||
                            "/placeholder.svg"
                          }
            ...
            <div className="bg-white rounded-2xl p-8 shadow-2xl border border-gray-200">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">
                  Garante já sua vaga nesta experiência única
                </p>
              </div>
            ...
            <div className="max-w-5xl mx-auto space-y-8">
              {activity.program.map((day, dayIndex) => {
                ...
                return (
                  ...
                  >
                    <h3 className="text-heading text-2xl font-bold text-gray-800 mb-8 text-center">
                      {dayContent.day}
                    </h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-7xl mx-auto">
              ...
              {activity.requirements && (
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
                  ...
                  <div className="space-y-4">
                    {activity.requirements[
                      currentLang as keyof typeof activity.requirements
              ...
              {activity.benefits && (
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
                  ...
                  <div className="space-y-4">
                    {activity.benefits[
                      currentLang as keyof typeof activity.benefits
                    ].map((benefit, index) => (
                      <div
                        key={index}
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg">
              Momentos e experiências anteriores
            </p>
            <div className="w-24 h-1 bg-gradient-to-r from-red-600 to-red-400 mx-auto rounded-full mt-4"></div>
          </div>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-red-100 mb-12 max-w-2xl mx-auto leading-relaxed">
              Não perca esta oportunidade de desenvolver suas habilidades
              artísticas conosco. Uma experiência transformadora te espera.
            </p>
